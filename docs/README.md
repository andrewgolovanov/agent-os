...
1. документ-владелец;
2. `state.md`, если изменилось фактическое состояние;
3. `roadmap.md`, если изменился следующий outcome;
4. `changelog.md`;
5. новый decision record, если решение неочевидно или отменяет старое.
