...
- The tag-triggered GitHub Release workflow completed successfully for
  `v0.3.2`: the exact tag checkout passed 68 Ruby tests/556 assertions, 23 Swift
  tests, plugin package validation, runtime synchronization, publication audit,
  signed packaging, and release creation in run `32059910788`.
- The public `v0.3.2` archive, checksum, and appcast were downloaded
  independently after publication. The checksum, strict bundle signature,
...
- The tag-triggered GitHub Release workflow completed successfully for
  `v0.4.1`: the exact tag checkout passed 73 Ruby tests/647 assertions, 29 Swift
  tests, plugin package validation, runtime synchronization, publication audit,
  signed packaging, and release creation in run `32080926193`.
- The public `v0.4.1` archive, checksum, and appcast were downloaded
  independently after publication. The archive SHA-256 is
...
- The public `v0.4.2` archive, checksum, and appcast were downloaded
  ...
  latest appcast URL and length, and Sparkle Ed25519 signature all passed.
- The tag-triggered GitHub Release workflow completed successfully for
  `v0.4.3`: the exact tag checkout passed 77 Ruby tests/705 assertions, 29 Swift
  tests, plugin package validation, runtime synchronization, publication audit,
  signed packaging, and release creation in run `32300042057`.
- The public `v0.4.3` archive, checksum, and appcast were downloaded
  independently after publication. The archive SHA-256 is
  `96e8bd3ce6c9eaff5f2040d674b27eca2d8abdac307e6ced581cdd6f22b848f5`;
  its checksum, strict bundle signature, version `0.4.3`, macOS 14 minimum,
  Apple Silicon executable, exact 22-file embedded runtime and modes, stable
...
- The tag-triggered GitHub Release workflow completed successfully for
  `v0.5.0`: the exact tag checkout passed 86 Ruby tests/751 assertions, 30 Swift
  tests, plugin package validation, runtime synchronization, publication audit,
  signed packaging, and release creation in run `32495953322`.
- The public `v0.5.0` archive, checksum, and appcast were downloaded
  independently after publication. The archive SHA-256 is
  `244ad1c6d445a9dacf3dc6a0036a407ed37d91d4e743095cf283d39f329754cb`;
  its checksum, strict bundle signature, version `0.5.0`, macOS 14 minimum,
...
- The public `v0.6.0` archive, checksum, and appcast were downloaded
  ...
  passed the complete Agent OS validation.
- The tag-triggered GitHub Release workflow completed successfully for
  `v0.7.0`: the exact tag checkout passed 105 Ruby tests/862 assertions, 37
  Swift tests, plugin package validation, runtime synchronization, publication
  audit, signed packaging, and release creation in run `32508847564`.
- The public `v0.7.0` archive, checksum, and appcast were downloaded
  independently after publication. The archive SHA-256 is
  `0eb48199f6a29e6ceae12d2c304a3c2464983038493ec1904a8c06c70a5e2eea`;
  its checksum, strict bundle signature, version `0.7.0`, plugin version
  `0.7.0+codex.20260821172747`, macOS 14 minimum, Apple Silicon executable,
...
- The tag-triggered GitHub Release workflow completed successfully for
  `v0.7.1`: the exact tag checkout passed 105 Ruby tests/862 assertions, 37
  Swift tests, plugin package validation, runtime synchronization, publication
  audit, signed packaging, and release creation in run `32512791540`.
- The public `v0.7.1` archive, checksum, and appcast were downloaded
  independently after publication. The archive SHA-256 is
  `9b3d660aea1bcdbfd793144afc21534f0fcc76e539afba15fe425a412760ceb1`;
  its checksum, strict bundle signature, version `0.7.1`, plugin version
  `0.7.1+codex.20260821201513`, macOS 14 minimum, Apple Silicon executable,
  exact 23-file embedded runtime, stable latest appcast URL and length, and
  Sparkle Ed25519 signature all passed. A fresh anonymous tag clone initialized
  a separate empty private home and passed the complete Agent OS validation.
- The tag-triggered GitHub Release workflow completed successfully for
