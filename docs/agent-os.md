...
Status: public source and `v0.2.1` checkout-independent release published
...
the matching GitHub Actions secret is configured, and `v0.2.1` is published.
