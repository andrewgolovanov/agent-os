...
7. Never pass or infer Agent OS source or private-home roots. The plugin bootstraps and constrains them automatically; project repository paths remain explicit onboarding inputs.
